...
public interface IBoardTravel {
	...
	public List<HashMap<String, Object>> selectTravelByLoc_Category(String loc_category);
	public List<HashMap<String, Object>> selectTravelBySub_Category(String sub_category);
