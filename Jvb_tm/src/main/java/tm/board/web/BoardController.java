...
public class BoardController {
	...
	public ModelAndView noticeView(HttpServletRequest req, int boardIdx, @RequestParam(defaultValue = "1") int page,
			String searchValue) {
	...
	public ModelAndView travelList(@RequestParam(defaultValue = "1") int page, String locCategory, String subCategory) {
	...
	public @ResponseBody String travelListJSon(@RequestParam(defaultValue = "1") int page, String locCategory,
			String subCategory) {
		String code = "t";
		Gson gson = new Gson();
	...
	public String travelWrite(HttpServletRequest req, BoardVo board) {
	...
	public ModelAndView travelView(HttpServletRequest req, int boardIdx, @RequestParam(defaultValue = "1") int page,
			String locCategory, String subCategory) {
	...
	public String travelModify(HttpServletRequest req, BoardVo board) {
	...
	public ModelAndView guideList(@RequestParam(defaultValue = "1") int page, String locCategory, String subCategory) {
		String code = "g";
		ModelAndView mav = new ModelAndView();
		mav.addAllObjects(boardService.getCommonBoardList(code, page, locCategory, subCategory));
	...
	public @ResponseBody String guideListJSon(@RequestParam(defaultValue = "1") int page, String locCategory,
			String subCategory) {
		String code = "g";
		Gson gson = new Gson();
		String str = gson.toJson(boardService.getCommonBoardList(code, page, locCategory, subCategory));
	...
	public String guideWrite(HttpServletRequest req, BoardVo board, ContentsVo contents) {
	...
	public ModelAndView guideView(HttpServletRequest req, int boardIdx, @RequestParam(defaultValue = "1") int page,
			String locCategory, String subCategory) {
	...
	public String guideModify(HttpServletRequest req, BoardVo board, ContentsVo contents) {
		String[] latLngArr = req.getParameterValues("latLng");
	...
	public ModelAndView reviewList(@RequestParam(defaultValue = "1") int page, String searchValue, String subCategory) {
		String code = "r";
		ModelAndView mav = new ModelAndView();
	...
	public @ResponseBody String reviewListJSon(@RequestParam(defaultValue = "1") int page, String searchValue,
			String subCategory) {
		String code = "r";
		Gson gson = new Gson();
	...
	public ModelAndView reviewView(HttpServletRequest req, int boardIdx, @RequestParam(defaultValue = "1") int page,
			String searchValue, String subCategory) {
		String userid = (String) (req.getSession().getAttribute("userid"));
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView reviewUpdate(BoardVo board, ContentsVo contents, @RequestParam("ufile") MultipartFile file,
			String img_idx) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView commentsWrite(HttpSession session, CommentsVo comments, String parent_cm, String site,
			String b_writer, String b_code, int comment_pre_depth) {
		ModelAndView mav = new ModelAndView();
