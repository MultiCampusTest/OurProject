...
public class ImageController {
   ...
   @RequestMapping("imageProfileView.do")
   public void imageProfileView(String img_code, HttpServletResponse resp) throws IOException{
      ImageVo image = imageService.selectProfileOne(img_code);
