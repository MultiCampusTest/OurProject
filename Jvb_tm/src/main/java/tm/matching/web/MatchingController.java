...
public class MatchingController {
	...
	// public @ResponseBody HashMap<String, Object> matchingHolding(HttpSession
	// session, int b_idx, String mch_g_userid){
	...
	public @ResponseBody HashMap<String, Object> androidMatchingSuccess(String b_idx, String mch_g_userid,
			String mch_t_userid) {
...
//		int num = Integer.parseInt(str[0]);
	...
	public @ResponseBody HashMap<String, Object> matchingReject(HttpSession session, int b_idx, String mch_g_userid) {
		...
		// params.put("mch_List_Reload",
		// matchingService.matchingList(mch_t_userid));
